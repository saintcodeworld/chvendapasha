                    ...
                    <div className="text-center max-w-lg w-full">
                        ...
                        <div className="mb-12">
                            <div className="mb-6 flex justify-center">
                                <img src={mainLogo} alt="White Whale Runner by $WhiteWhale Dev" className="w-24 h-24 drop-shadow-[0_0_20px_rgba(26,26,26,0.5)]" />
                            </div>
                            <h1 className="text-5xl font-black text-white mb-3 tracking-tighter italic">
                                White Whale Runner by $WhiteWhale Dev
                            </h1>
                        </div>
